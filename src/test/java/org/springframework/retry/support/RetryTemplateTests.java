...
public class RetryTemplateTests {
    ...
    public void anotherTestSpecificExceptionRetry() throws Throwable {
        final RetryCallback<String, RuntimeException> callback = new RetryCallback<String, RuntimeException>() {
            @Override
        ...
        final SimpleRetryPolicy retryPolicy = new SimpleRetryPolicy(4, Collections.<Class<? extends Throwable>,
                Boolean>singletonMap(RuntimeException.class, true));
	...
	public void testRollbackClassifierOverridesRetryPolicy() throws Throwable {
		...
		BinaryExceptionClassifier classifier = new BinaryExceptionClassifier(
				...
				false);
		retryTemplate.execute(callback, new DefaultRetryState("asdas", classifier));
		assertEquals(attempts, callback.attempts);
	}
